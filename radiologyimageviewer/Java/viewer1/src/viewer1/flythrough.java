...
public class flythrough extends JPanel{
	...
	viewerApplet_view  winSuface;	
	
	public class viewerApplet_view  extends JFrame implements KeyListener{
        ...
        public void init(){
			...
			try
			{
				...
				long startTime1 = System.currentTimeMillis();//计算起始时间
...
//	    Vector3f translation = new Vector3f();
	...
	public void fly_through() {
		// TODO Auto-generated method stub
		winSuface=new viewerApplet_view();
		winSuface.init();
		winSuface.setVisible(true);	
	} 
