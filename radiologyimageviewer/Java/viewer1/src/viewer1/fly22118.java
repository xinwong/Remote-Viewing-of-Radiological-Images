...
public class fly22118 extends JFrame implements Runnable {
...
//    transform.get(translation);
    ...
    JFrame frame = new JFrame("fly through 22118");
    ...
    public static void main(String args[])
   	{
    	fly22118 fly22118 = new fly22118();
    	fly22118.flying();
   	} 
...
//    		Download.downLoadFromUrl("http://134.175.21.96:8080/do/22118CTC.dat"
//									,"22118CTC.dat"
//									,"/Users/min/Desktop/");

			Download.downLoadFromUrl("http://134.175.21.96:8080/do/vertex22118"
									,"vertex22118"
									,"C:\\datset\\");//static，静态的可以直接用类名调用
		}catch (Exception e) {
		}	
    	System.out.println("vertex22118");
	}
...
//									,"/Users/min/Desktop/");
			...
			Download.downLoadFromUrl("http://134.175.21.96:8080/do/normal22118"
									,"normal22118"
									,"C:\\datset\\");//static，静态的可以直接用类名调用
		}catch (Exception e) {
		}	 
    	System.out.println("normal22118");
	}
    
	public void read() {
		try
		{
			File inputFile =  new File("C:\\datset\\vertex22118");
//			File inputFile =  new File("/Users/min/Downloads/test/vertex22118");
//			File inputFile =  new File("/home/ln/do/vertex22118");
...
//			File inputFile2 =  new File("/Users/min/Downloads/test/normal22118");
//			File inputFile2 =  new File("/home/ln/do/normal22118");
...
//			if ( (f.length()!=60973200)&&(f2.length()!=60973200) ) {
//				f.close();
//				f2.close();
//				return ;				
//			}
//-------------------------------------------------------------------------------
	        if (f.length() != 60973200) {
	    		Download.downLoadFromUrl("http://134.175.21.96:8080/do/vertex22118"
	    				,"vertex22118"
	    				,"C:\\datset\\");//static，静态的可以直接用类名调用
	    		System.out.println("f.length()..."+f.length());
			}
	        if (f2.length() != 60973200) {
	    		Download.downLoadFromUrl("http://134.175.21.96:8080/do/normal22118"
	    				,"normal22118"
	    				,"C:\\datset\\");//static，静态的可以直接用类名调用
	    		System.out.println("f2.length()..."+f2.length());
...
//			float[] vertex = new float[4292088*3];‬
			...
			triangle = new TriangleArray(5081100, TriangleArray.COORDINATES|TriangleArray.NORMALS);//COORDINATES指定此GeometryArray包含坐标数组。必须设置此位  | NORMALS指定此GeometryArray包含法线数组。
			triangle.setCoordinates(0, vertex,0,5081100);//setCoordinates(int index,float []坐标,int start,int length);index - 在此几何数组中开始目标顶点索引; coordinates - 包含n个新坐标的3 * n值的源数组; start- 在coordinates数组中启动源顶点索引。; length - 要复制的顶点数。
			triangle.setNormals(0, normal, 0, 5081100);//参数：index - 在此几何数组中开始目标顶点索引; normals - 包含新法线的向量的源数组; start- 在normals数组中启动源顶点索引。; length - 要复制的法线数。
...
//	        }		  
		...
		System.out.println((double)i/((startTime4-startTime3)/1000));	
