...
public class reconstruction08779 extends JFrame implements KeyListener , Runnable {
	...
	public static void main(String[] args) {
		...
		reconstruction08779 reconstruction08779 = new reconstruction08779();
		reconstruction08779.reconstruction();
	}
...
//-------------------------------------------------------------------------------
		...
		float[] normal=new float[5140116*3]; //     51505056/4/3=4292088
		...
		triangle = new TriangleArray(5140116, TriangleArray.COORDINATES|TriangleArray.NORMALS);
		triangle.setCoordinates(0,vertex,0,5140116);
		triangle.setNormals(0, normal, 0, 5140116);
