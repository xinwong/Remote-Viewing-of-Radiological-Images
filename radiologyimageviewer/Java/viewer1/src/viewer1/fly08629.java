...
public class fly08629 extends JFrame implements Runnable {
...
//    transform.get(translation);
    ...
    JFrame frame = new JFrame("fly through 08629");
    ...
    public static void main(String args[])
   	{
    	fly08629 fly08629 = new fly08629();
    	fly08629.flying();
   	} 
...
//									,"/Users/min/Desktop/");
    	...
    	System.out.println("vertex08629");
	}
...
//									,"/Users/min/Desktop/");
    	...
    	System.out.println("normal08629");
	}
...
//			float[] vertex = new float[4292088*3];‬
			...
			triangle = new TriangleArray(4927740, TriangleArray.COORDINATES|TriangleArray.NORMALS);//COORDINATES指定此GeometryArray包含坐标数组。必须设置此位  | NORMALS指定此GeometryArray包含法线数组。
			triangle.setCoordinates(0, vertex,0,4927740);//setCoordinates(int index,float []坐标,int start,int length);index - 在此几何数组中开始目标顶点索引; coordinates - 包含n个新坐标的3 * n值的源数组; start- 在coordinates数组中启动源顶点索引。; length - 要复制的顶点数。
			triangle.setNormals(0, normal, 0, 4927740);//参数：index - 在此几何数组中开始目标顶点索引; normals - 包含新法线的向量的源数组; start- 在normals数组中启动源顶点索引。; length - 要复制的法线数。
