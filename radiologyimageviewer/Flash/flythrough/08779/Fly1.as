 ...
 */  
    ...
    var pointX=[100,164,168,172,173,174,175,166.25,157.5,148.75,140];//,243,252,248,250,253]; //+是右边 -是左边
  
   var pointY=[100,123,127,131,135,139,144,147,152,157,162,167];//,487,511,525,542,562];
  
   var pointZ=[100,157,159,161,148.5,136,123.5,111,104,197,193];//,176,174,184,193,211]; //+是下边 -是上边
   ...
   var eyeZ:Array=new Array;
	 ...
	 var framerate:Array=new Array;
		...
		function read():void
		{
			...
			var request:URLRequest = new URLRequest("vertex08779");
		...
		{
			var request:URLRequest = new URLRequest("normal08779");
