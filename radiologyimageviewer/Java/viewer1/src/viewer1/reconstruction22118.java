...
public class reconstruction22118 extends JFrame implements KeyListener , Runnable {
	...
	public static void main(String[] args) {
		...
		reconstruction22118 reconstruction22118 = new reconstruction22118();
		reconstruction22118.reconstruction();
	}
...
//-------------------------------------------------------------------------------
		...
		float[] normal=new float[60973200*3]; //     51505056/4/3=4292088
		float[] vertex=new float[60973200*3]; 
		...
		triangle = new TriangleArray(5081100, TriangleArray.COORDINATES|TriangleArray.NORMALS);
		triangle.setCoordinates(0,vertex,0,5081100);
		triangle.setNormals(0, normal, 0, 5081100);
