...
public class fly08779 extends JFrame implements Runnable {
...
//    transform.get(translation);
    ...
    JFrame frame = new JFrame("fly through 08779");
    ...
    public static void main(String args[])
   	{
    	fly08779 fly08779 = new fly08779();
    	fly08779.flying();
   	} 
...
//    		Download.downLoadFromUrl("http://134.175.21.96:8080/do/08779CTC.dat"
//									,"08779CTC.dat"
//									,"/Users/min/Desktop/");
...
//			File inputFile =  new File("/Users/min/Downloads/test/vertex08779");
//			File inputFile =  new File("/home/ln/do/vertex08779");
...
//			File inputFile2 =  new File("/Users/min/Downloads/test/normal08779");
//			File inputFile2 =  new File("/home/ln/do/normal08779");
...
//			if ( (f.length()!=59132880)&&(f2.length()!=59132880) ) {
//				f.close();
//				f2.close();
//				return ;				
//			}
...
//-------------------------------------------------------------------------------
	        if (f.length() != 61681392 ) {
	    		Download.downLoadFromUrl("http://134.175.21.96:8080/do/vertex08779"
	    				,"vertex08779"
	    				,"C:\\datset\\");//static，静态的可以直接用类名调用
	    		System.out.println("f.length()..."+f.length());
			}
	        if (f2.length() != 61681392) {
	    		Download.downLoadFromUrl("http://134.175.21.96:8080/do/normal08779"
	    				,"normal08779"
	    				,"C:\\datset\\");//static，静态的可以直接用类名调用
	    		System.out.println("f2.length()..."+f2.length());
...
//			float[] vertex = new float[4292088*3];‬
			...
			triangle = new TriangleArray(5140116, TriangleArray.COORDINATES|TriangleArray.NORMALS);//COORDINATES指定此GeometryArray包含坐标数组。必须设置此位  | NORMALS指定此GeometryArray包含法线数组。
			triangle.setCoordinates(0, vertex,0,5140116);//setCoordinates(int index,float []坐标,int start,int length);index - 在此几何数组中开始目标顶点索引; coordinates - 包含n个新坐标的3 * n值的源数组; start- 在coordinates数组中启动源顶点索引。; length - 要复制的顶点数。
			triangle.setNormals(0, normal, 0, 5140116);//参数：index - 在此几何数组中开始目标顶点索引; normals - 包含新法线的向量的源数组; start- 在normals数组中启动源顶点索引。; length - 要复制的法线数。
